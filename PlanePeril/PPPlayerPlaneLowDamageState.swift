//
//  PPPlayerPlaneLowDamageState.swift
//  PlanePeril
//
...
class PPPlayerPlaneLowDamageState: GKState{
    ...
    override func isValidNextState(_ stateClass: AnyClass) -> Bool {
        ...
        case is PPPlayerPlaneMediumFuelState.Type, is PPPlayerPlaneLowFuelState.Type, is PPPlayerPlaneHighFuelState.Type:
            return true
        case is PPPlayerPlaneMediumDamageState.Type, is PPPlayerPlaneHighDamageState.Type:
            return true
