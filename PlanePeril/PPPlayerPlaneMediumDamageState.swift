//
//  PPPlayerPlaneMediumDamageState.swift
//  PlanePeril
//
...
class PPPlayerPlaneMediumDamageState: GKState{
    ...
    override func isValidNextState(_ stateClass: AnyClass) -> Bool {
        switch(stateClass){
        case is PPPlayerPlaneMediumFuelState.Type, is PPPlayerPlaneLowFuelState.Type, is PPPlayerPlaneHighFuelState.Type:
            return true
        case is PPPlayerPlaneHighDamageState.Type, is PPPlayerPlaneLowDamageState.Type:
            return true
