//
//  GKPlayerPlaneHighDamageState.swift
//  PlanePeril
//
...
class PPPlayerPlaneHighDamageState: GKState{
    ...
    override func isValidNextState(_ stateClass: AnyClass) -> Bool {
        ...
        case is PPPlayerPlaneMediumFuelState.Type, is PPPlayerPlaneLowFuelState.Type, is PPPlayerPlaneHighFuelState.Type:
            return true
        case is PPPlayerPlaneMediumDamageState.Type, is PPPlayerPlaneLowDamageState.Type:
            return true
