//
//  PPPlayerPlaneLowFuelState.swift
//  PlanePeril
//
...
class PPPlayerPlaneLowFuelState: GKState{
    ...
    override func didEnter(from previousState: GKState?) {
        ...
        //Request the "move slow" animation for the player plane
        
        animationComponent.requestedAnimationState = .moveSlow
    }
    ...
    override func isValidNextState(_ stateClass: AnyClass) -> Bool {
        ...
        switch(stateClass){
            case is PPPlayerPlaneMediumFuelState.Type,is PPPlayerPlaneHighFuelState.Type:
                return true
